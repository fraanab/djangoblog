...
from core.views import frontpage, signup, myaccount, edit_myaccount, admin_dashboard, contact, newsletterinfo, sendnewsletter, newpost, newhtml
from posts.views import postpage
